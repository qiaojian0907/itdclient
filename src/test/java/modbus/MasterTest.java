...
public class MasterTest {
    public static void main(String[] args) throws Exception {
        ...
        ipParameters.setHost("192.168.31.198");
        ...
        try {
            ...
            BaseLocator<Number> locator = BaseLocator.holdingRegister(slaveId, 0, DataType.EIGHT_BYTE_INT_UNSIGNED);
            master.setValue(locator, 8888);
            System.out.println(master.getValue(locator));
        }
        finally {
            master.destroy();
