            ...
            return this.each(function() {
                ...
                for(var i in settings.columns) {
                    ...
                    default_columns_list += '<li><a href="javascript:void(0);">' +
                        ...
                        '<input type="checkbox" data-switch-no-init class="' + settings.columnsListCheckClass + '"' + col_checked + '> ' + col_name +
                        '</label>' +
                        '</a></li>';
                }
                ...
                for(var i in settings.sorting) {
                    ...
                    default_sorting_list += '<li><a href="javascript:void(0);">' +
                        '<label class="' + settings.sortingLabelCheckboxClass + '"><input type="radio" data-switch-no-init name="' + sorting_radio_name + i + '"' + checked_asc + '>' + rsc_bs_dg.sort_ascending + '</label>' +
                        '<label class="' + settings.sortingLabelCheckboxClass + '"><input type="radio" data-switch-no-init name="' + sorting_radio_name + i + '"' + checked_desc + '>' + rsc_bs_dg.sort_descending + '</label>' +
                        '<label class="' + settings.sortingLabelCheckboxClass + '"><input type="radio" data-switch-no-init name="' + sorting_radio_name + i + '"' + checked_none + '>' + rsc_bs_dg.sort_none + '</label>' +
...
*/
                ...
                elem_table.off("click", "tbody tr td").on("click", "tbody tr td", function() {
                    ...
                    elem.triggerHandler("onCellClick", {col: col_index, row: row_index,text:select_text});
                });
                ...
                elem_table.off("click", "thead th").on("click", "thead th", function() {
                    ...
                    if(th_field) {
                        ...
                        var sorting_list_html = '<li><a href="javascript:void(0);">' +
                            '<label class="' + settings.sortingLabelCheckboxClass + '"><input type="radio" data-switch-no-init name="' + sorting_radio_name + '0' + '"' + checked_asc + '>' + rsc_bs_dg.sort_ascending + '</label>' +
                            '<label class="' + settings.sortingLabelCheckboxClass + '"><input type="radio" data-switch-no-init name="' + sorting_radio_name + '0' + '"' + checked_desc + '>' + rsc_bs_dg.sort_descending + '</label>' +
                            '<label class="' + settings.sortingLabelCheckboxClass + '"><input type="radio" data-switch-no-init name="' + sorting_radio_name + '0' + '"' + checked_none + '>' + rsc_bs_dg.sort_none + '</label>' +
